...
from posApp.forms import CreditorForm, DebtorForm, StockForm
from posApp.models import Category, Creditor, Debtors, Products, Sales, salesItems,Stock
...
class StockListView(ListView):
    model = Stock
    template_name = 'posApp/stock_list.html'
    context_object_name = 'stocks'

class StockCreateUpdateView(View):
    template_name = 'posApp/stock_form.html'
